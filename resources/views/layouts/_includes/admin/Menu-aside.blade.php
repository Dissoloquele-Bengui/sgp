        ...
        <div class="d-flex flex-between-center">
            ...
            <a class="navbar-brand me-1 me-sm-3" href="index.html">
                <div class="d-flex align-items-center"><span
                        class="font-sans-serif text-primary">LAB-FÍSICA</span></div>
            </a>
                                    ...
                                    <div class="row text-center gx-0 gy-0">
                                        ...
                                        <div class="col-4"><a
                                                ...
                                                href="https://mailbluster.com/" target="_blank"><img class="rounded"
                                                    ...
                                                    width="40" height="40" />
                                                <p class="mb-0 fw-medium text-800 text-truncate fs-11 pt-1">Mailbluster
                                                </p>
                                            </a></div>
                                        <div class="col-4"><a
                                                class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none"
                                ...
                                <div class="row">
                                    <div class="col-6 col-md-4">
                                        <div class="nav flex-column"><a class="nav-link py-1 link-600 fw-medium"
                                                href="{{ route('admin.classe.list') }}">Classe</a><a
        ...
        <div class="navbar-vertical-content scrollbar">
            <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item"><!-- label-->
                    ...
                    </div><!-- parent pages--><a class="nav-link" href="{{ route('admin.classe.list') }}"
                        role="button">
                        <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                    class="fas fa-calendar-alt"></span></span><span
                                class="nav-link-text ps-1">Classe</span></div>
                    </a>
                    <a class="nav-link" href="{{ route('admin.classe.list') }}"
                        role="button">
                        <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                    class="fas fa-calendar-alt"></span></span><span
                                class="nav-link-text ps-1">Disciplina</span></div>
                    </a>
                    <a class="nav-link" href="{{ route('admin.classe.list') }}"
                        role="button">
                        <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                    class="fas fa-calendar-alt"></span></span><span
                                class="nav-link-text ps-1">Submeter material</span></div>
                    </a>
                </li>
            </ul>
        </div>
