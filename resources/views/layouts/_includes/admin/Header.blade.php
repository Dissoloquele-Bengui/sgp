...
<head>
    ...
    <!-- ===============================================--><!--    Favicons--><!-- ===============================================-->
    <link rel="app-le-touch-icon" sizes="180x180" href="/assets/img/favicons/apple-touch-icon.png">
...
<body>
    ...
    <main class="main" id="top">
        <div class="container" data-layout="container">
            ...
            @include('layouts._includes.admin.Menu-aside')
            ...
            <div class="content">
                <nav class="navbar navbar-light navbar-glass navbar-top navbar-expand" style="display: none;">
                    ...
                    <a class="navbar-brand me-1 me-sm-3" href="index.html">
                        <div class="d-flex align-items-center"><span class="font-sans-serif text-primary">LAB-FÍSICA</span></div>
                    </a>
                ...
                @include('layouts.modal.dashbord.index')
