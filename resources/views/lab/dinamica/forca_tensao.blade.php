...
@section('titulo', 'Força de Tensão em Cordas')
@section('conteudo')
    <style>
        main#tracaoPolias {
            min-height: 520px;
                ...
                <div class="row gx-0 flex-between-center">
                    <div class="col-sm-auto d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h4 class="text-primary fw-bold mb-0">Força de Tensão em Cordas(Dinâmica) <span
                ...
                <div class="card-header " data-bs-theme="light">
                    <main id="oneBox">
                        <div class="box">
                          ...
                          <div class="horizontalLine goBackDirection">
