...
@section('titulo', 'Terceira Lei de Newton')
@section('conteudo')
    <style>
        /* body {
                display: flex;
                ...
                <div class="row gx-0 flex-between-center">
                    <div class="col-sm-auto d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h4 class="text-primary fw-bold mb-0">Terceira Lei de Newton(Dinâmica) <span
                        ...
                        <div class="box">
                            <div class="box1">
                                ...
                                <div class="horizontalLine">
                                    <img src="./assets/left_arrow_icon.svg" class="directionRight direction" />
                                </div>
                            </div>
                            ...
                            <div class="horizontalLine">
                                ...
                                <img src="./assets/left_arrow_icon.svg" class="directionLeft direction" />
    ...
    <script>
        ...
        function startSimulation() {
            ...
            interval = setInterval(() => {
                ...
                let tensionForce =
                    parseInt(document.querySelector("#tensionValue").value) /
                    (mass + mass1);
