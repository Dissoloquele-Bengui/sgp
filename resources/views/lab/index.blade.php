                    ...
                    <div class="row">
                      ...
                      <div class="col-6 col-xxl-3">
                        <div class="nav flex-column mt-md-4 pt-md-1"><a class="nav-link py-1 link-600 fw-medium"
                            ...
                            class="nav-link py-1 link-600 fw-medium"
                            href="modules/components/navs-and-tabs/vertical-navbar.html">Navbar vertical</a></div>
                      </div>
                      <div class="col-6 col-xxl-3">
                      ...
                      <div class="col-6 col-xxl-3">
                        <div class="nav flex-column">
                          <p class="nav-link text-700 mb-0 fw-bold">Utilities</p><a
                            ...
                            class="nav-link py-1 link-600 fw-medium" href="modules/utilities/icon-link.html">Icon
                            ...
                            class="nav-link py-1 link-600 fw-medium" href="modules/utilities/ratio.html">Ratio</a><a
                            class="nav-link py-1 link-600 fw-medium" href="modules/utilities/spacing.html">Spacing</a><a
                            class="nav-link py-1 link-600 fw-medium" href="modules/utilities/sizing.html">Sizing</a><a
                            class="nav-link py-1 link-600 fw-medium"
                      ...
                      <div class="col-6 col-xxl-3">
                        <div class="nav flex-column">
                          ...
                          <p class="nav-link text-700 mb-0 fw-bold">Charts</p><a
                            class="nav-link py-1 link-600 fw-medium" href="modules/charts/chartjs.html">Chartjs</a><a
                      ...
                      <div class="col-6 col-xxl-3">
                        <div class="nav flex-column">
                          <p class="nav-link text-700 mb-0 fw-bold">Forms</p><a class="nav-link py-1 link-600 fw-medium"
                            ...
                            href="modules/forms/wizard.html">Wizard</a><a class="nav-link py-1 link-600 fw-medium"
                        ...
                        <div class="col-6 col-xxl-3">
                          <div class="nav flex-column">
                            <p class="nav-link text-700 mb-0 fw-bold">Utilities</p><a
                              ...
                              class="nav-link py-1 link-600 fw-medium" href="modules/utilities/focus-ring.html">Focus
                              ring</a><a class="nav-link py-1 link-600 fw-medium"
                              href="modules/utilities/grid.html">Grid</a><a class="nav-link py-1 link-600 fw-medium"
          ...
          <div class="row">
            <div class="col-xl-8 position-relative">
              <div class="row g-3 align-items-center">
                ...
                <div class="col-lg-7">
                  <h6 class="fw-semi-bold text-400">Feito por  <a class="text-info" href="app/e-learning/trainer-profile.html">Nome da Plataforma</a></h6>
                  <h2 class="fw-bold text-white">LABORATÓRIO-FÍSICA </h2>
                  <p class="text-white fw-semi-bold fs-10"><span class="me-1">4.8</span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star-half-alt text-warning star-icon"></span><span class="text-info ms-2">(6,899 view)</span></p>
              ...
              <ul class="list-unstyled d-flex flex-wrap gap-3 fs-10 fw-semi-bold text-300 mt-3 mb-0">
                <li><span class="fas fa-graduation-cap text-white me-1"> </span>7,302 Subtemas </li>
                <li><span class="fas fa-user-graduate text-white me-1"> </span>45 Exercícios</li>
                <li><span class="fas fa-headphones text-white me-1"> </span>45 Vídeos</li>
                <li><span class="fas fa-closed-captioning text-white me-1"> </span>45 Documentos</li>
              </ul>
            </div>
          </div>
        </div>
            ...
            <div class="card-body">
              <div class="row gy-4 text-center text-md-start">
                <div class="col-md-4"><img class="mb-3" src="assets/img/icons/target.svg" width="36" alt="" />
                  <h6 class="fs-9 text-primary">Objectivo</h6>
                ...
                <div class="col-md-4"><img class="mb-3" src="assets/img/icons/discount.svg" width="36" alt="" />
                  <h6 class="fs-9 text-primary">Requerimentos</h6>
                ...
                <div class="col-md-4"><img class="mb-3" src="assets/img/icons/networking.svg" width="36" alt="" />
                  <h6 class="fs-9 text-primary">Aviso</h6>
            ...
            <div class="col-lg-8 pe-lg-2">
              <div class="card mb-3">
                <div class="card-header bg-body-tertiary">
                  <h5 class="mb-0" id="cinematica">Cinemâtica</h5>
                </div>
                <div class="card-body">
              ...
              <div class="card mb-3">
                <div class="card-header bg-body-tertiary">
                  <h5 class="mb-0" id="dinamica">Dinâmica </h5>
                </div>
                <div class="card-body">
                    <div class="d-flex align-items-center px-x1 py-2 border-bottom border-200">
                        <div class="hoverbox me-3 my-1"><a class="text-decoration-none" href="../../../assets/video/beach.mp4" data-gallery="attachment-bg">
              ...
              <div class="card mb-3">
                <div class="card-header bg-body-tertiary">
                  <h5 class="mb-0" id="dinamica">Mecânica </h5>
                </div>
                <div class="card-body">
                    <div class="d-flex align-items-center px-x1 py-2 border-bottom border-200">
                        <div class="hoverbox me-3 my-1"><a class="text-decoration-none" href="../../../assets/video/beach.mp4" data-gallery="attachment-bg">
              ...
              <div class="sticky-sidebar">
                <div class="card sticky-top">
                  <div class="card-header border-bottom">
                    <h6 class="mb-0 fs-9">Temas</h6>
                  </div>
                  <div class="card-body">
                    <div class="terms-sidebar nav flex-column fs-10" id="terms-sidebar">
                      <div class="nav-item"><a class="nav-link px-0 py-1" href="#cinematica">Cinemâtica</a></div>
                      <div class="nav-item"><a class="nav-link px-0 py-1" href="#dinamica">Dinâmica</a></div>
                      <div class="nav-item"><a class="nav-link px-0 py-1" href="#mecanica">Mecânica</a></div>
      ...
      <div class="btn-group d-block w-100 btn-group-navbar-style">
        <div class="row gx-2">
          <div class="col-4"><input class="btn-check" id="themeSwitcherLight" name="theme-color" type="radio"
              value="light" data-theme-control="theme" /><label class="btn d-inline-block btn-navbar-style fs-10"
          ...
          <div class="col-4"><input class="btn-check" id="themeSwitcherDark" name="theme-color" type="radio"
              value="dark" data-theme-control="theme" /><label class="btn d-inline-block btn-navbar-style fs-10"
          ...
          <div class="col-4"><input class="btn-check" id="themeSwitcherAuto" name="theme-color" type="radio"
              value="auto" data-theme-control="theme" /><label class="btn d-inline-block btn-navbar-style fs-10"
              for="themeSwitcherAuto"> <span class="hover-overlay mb-2 rounded d-block"><img
                  class="img-fluid img-prototype mb-0" src="assets/img/generic/falcon-mode-auto.jpg"
      ...
      <div class="btn-group d-block w-100 btn-group-navbar-style">
        <div class="row gx-2">
          ...
          <div class="col-6"><input class="btn-check" id="navbar-style-card" type="radio" name="navbarStyle"
              value="card" data-theme-control="navbarStyle" /><label class="btn d-block w-100 btn-navbar-style fs-10"
          ...
          <div class="col-6"><input class="btn-check" id="navbar-style-vibrant" type="radio" name="navbarStyle"
              value="vibrant" data-theme-control="navbarStyle" /><label class="btn d-block w-100 btn-navbar-style fs-10"
